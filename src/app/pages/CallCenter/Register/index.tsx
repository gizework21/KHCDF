...
function Register({ minimized }: CallCenterDashboardProps) {
  ...
  return (
    <>
      ...
      <div
        ...
        } items-center h-screen mt-16 right-0 fixed transition-all duration-500 ease-in overflow-scroll md:px-20`}
      >
        <form
          className="w-full px-5 pb-5 border border-gray-300 rounded-md sm:mt-5 flex flex-col sm:gap-10 mb-20"
